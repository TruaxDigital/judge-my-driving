    ...
    <div className="space-y-10 max-w-5xl mx-auto px-6">
      ...
      <div className="text-center space-y-3">
        <div className="flex justify-center mb-4">
          <img src="https://cdn.jsdelivr.net/gh/TruaxDigital/judge-my-driving@main/judge-my-driving-horizontal-logo-white.svg" alt="Judge My Driving" className="h-28 w-auto" />
        </div>
      ...
      {/* B2C */}
      <div>
        <h2 className="text-sm font-semibold text-muted-foreground uppercase tracking-widest mb-4 text-center">Personal Plans</h2>
      ...
      {/* Fleet */}
      <div>
        <h2 className="text-sm font-semibold text-muted-foreground uppercase tracking-widest mb-4 text-center">Fleet Plans</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch">
          {PLANS.filter(p => p.fleet).map(plan => (
            <PlanCard
              key={plan.id}
