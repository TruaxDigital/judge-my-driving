  ...
  return (
    ...
    >
      <div style={{ maxWidth: 880, margin: '0 auto', padding: '0 24px', textAlign: 'center' }}>
        ...
        <h1 style={{ fontSize: 'clamp(36px, 5vw, 56px)', fontWeight: 700, lineHeight: 1.1, margin: '0 0 24px' }}>
          You worry every time they drive.{' '}
          <span style={{ color: '#D4A017', display: 'block' }}>Now you'll know.</span>
        </h1>

        <p style={{ color: '#B8B8B8', fontSize: 'clamp(17px, 2vw, 18px)', lineHeight: 1.55, maxWidth: 640, margin: '0 auto 32px' }}>
      ...
      <style>{`
        ...
        @media (min-width: 640px) {
          .sr-trust-grid { grid-template-columns: repeat(4, 1fr); max-width: none; }
        }
      `}</style>
    </section>
  );
