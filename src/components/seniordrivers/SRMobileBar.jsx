...
export default function SRMobileBar({ heroVisible, pricingVisible }) {
  ...
  return (
    ...
    >
      ...
      <style>{`@media (min-width: 769px) { .sr-mobile-bar { display: none !important; } }`}</style>
    </div>
  );
}