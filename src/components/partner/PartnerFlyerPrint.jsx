...
<body>
  ...
  <div class="flyer">
    ...
    <div style="padding:14px 40px 18px;text-align:center;border-top:1px solid ${c.cardBorder};margin-top:4px;">
      <img src="https://raw.githubusercontent.com/TruaxDigital/judge-my-driving/refs/heads/main/judge-my-driving-horizontal-logo-dark.svg.svg" alt="Judge My Driving" style="height:32px;width:auto;display:block;margin:0 auto 4px;" />
