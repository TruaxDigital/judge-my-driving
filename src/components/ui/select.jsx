    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          isMobile
            ? "fixed inset-x-0 bottom-0 z-[100] rounded-t-2xl max-h-[60vh] data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom"
            : cn(
        ...
        {...props}>
        {isMobile && <div className="mx-auto mt-3 mb-1 h-1.5 w-12 rounded-full bg-muted-foreground/30" />}
        <SelectScrollUpButton />
        <SelectPrimitive.Viewport
          className={cn("p-2", !isMobile && position === "popper" &&
