    ...
    <>
      <nav style={{
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', width: '100%', padding: '0 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 32 }} className="sd-desktop-nav">
            {links.map(l => (
              <a
                key={l.label}
                href={l.href}
      ...
      <style>{`
        @media (max-width: 768px) { .sd-desktop-nav { display: none !important; } .sd-mobile-nav { display: block !important; } }
        @media (min-width: 769px) { .sd-desktop-nav { display: flex !important; } .sd-mobile-nav { display: none !important; } }
